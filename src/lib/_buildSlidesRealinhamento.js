...
export function buildSlidesRealinhamento(d, slides = []) {
  ...
  slides.push(slide('s1r',
    ...
    +'<div style="padding:56px 64px;display:flex;flex-direction:column;justify-content:space-between;border-right:1px solid '+BL+'">'
      +'<div style="display:flex;align-items:center;gap:12px">'+LOGO+'<span style="font-size:.56rem;font-weight:600;letter-spacing:.14em;text-transform:uppercase;color:'+LGRAY+'">Brasília · DF</span></div>'
      +'<div>'
    ...
    +'<div style="background:'+BLLT+';padding:56px 64px;display:flex;flex-direction:column;justify-content:space-between">'
      ...
      +'<div style="display:flex;flex-direction:column;gap:1px;background:rgba(26,76,139,.12)">'
        ...
        +(precoOrigNum>0?'<div style="background:'+BLUE+';padding:20px 24px;display:flex;justify-content:space-between;align-items:center"><div style="font-size:.76rem;color:rgba(255,255,255,.65)">Preço anunciado</div><div style="font-size:1.02rem;font-weight:700;color:'+W+'">'+fmtBRL(precoOrigNum)+'</div></div>':'')
        +(maiorProposta>0?'<div style="background:#fff8f0;border-top:2px solid '+GOLD+';padding:20px 24px;display:flex;justify-content:space-between;align-items:center"><div style="font-size:.76rem;color:'+GRAY+'">Melhor proposta</div><div style="font-size:1.02rem;font-weight:700;color:#92400e">'+fmtBRL(maiorProposta)+'</div></div>':'')
      +'</div>'
