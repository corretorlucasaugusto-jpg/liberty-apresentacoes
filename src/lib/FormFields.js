...
export const NVRow = ({ idx, total, onRemove, onExtract, extracting, tipoImovel, notFound = {} }) => {
...
export const VRow = ({ idx, total, onRemove, onExtract, extracting, tipoImovel, notFound = {} }) => {
  const isTer = isTerrenoType(tipoImovel)
